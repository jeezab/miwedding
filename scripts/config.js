window.WEDDING_CONFIG = {
  ...
  heroDescription: "Мы готовимся к самому важному для нас событию — дню свадьбы! Будем счастливы разделить этот день с самыми близкими людьми и надеемся увидеть вас среди гостей!",
  storyTitle: "Мы станем семьёй!",
  storyText: "Мы готовимся к самому важному для нас событию — дню свадьбы! Будем счастливы разделить этот день с самыми близкими людьми и надеемся увидеть вас среди гостей!",
  ...
  wishesSlides: [
    "Вместо большого букета отдайте предпочтение одному красивому цветку - из них получится цельная цветочная композиция! Если вы хотите порадовать нас подарком - поместите всё в конверт! Это будет лучшей поддержкой для нашей молодой семьи ❤️",
    "Мы будем рады, если Вы поддержите нас хорошим настроением и красивыми нарядами! Только, пожалуйста, не выбирайте для своего образа чёрный и белый цвет.",
    "Вход к нам на свадьбу будет осуществляться по лотерейным билетам! :) Подойдёт любой. А после свадьбы молодожёны проверят их на удачу!"
  ],
