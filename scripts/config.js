window.WEDDING_CONFIG = {
  ...
  wishesSlides: [
    "Вместо большого букета отдайте предпочтение одному красивому цветку - из них получится цельная цветочная композиция!\nЕсли вы хотите порадовать нас подарком - поместите всё в конверт. Это будет лучшей поддержкой для нашей молодой семьи ❤️",
    "Небольшая просьба для девушек: не выбирайте для своего образа чёрный и белый цвет.",
